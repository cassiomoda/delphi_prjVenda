...
type
  TDM = class(TDataModule)
    ...
    itemVendaQryBtnExcluir: TStringField;
    descontoVendaQryBtnExcluir: TStringField;
    receitaVendaQryBtnExcluir: TStringField;
...
begin
  try
    ...
    begin
      ...
      receitaVendaQry.ApplyUpdates(0);
      receitaVendaQry.Close;
      ...
      descontoVendaQry.ApplyUpdates(0);
      descontoVendaQry.Close;
